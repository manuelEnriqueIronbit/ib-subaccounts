...
import style from './ib-subaccount-register-styles.js';

class IbSubaccountRegister extends LitElement {
...
window.customElements.define("ib-subaccount-register", IbSubaccountRegister);
